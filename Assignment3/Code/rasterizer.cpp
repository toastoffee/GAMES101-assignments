...
void rst::rasterizer::rasterize_triangle(const Triangle &t, const std::array<Eigen::Vector3f, 3> &view_pos)
{
    ...
    float boxXmin = v[0].x(), boxXmax = v[0].x(), boxYmin = v[0].y(), boxYmax = v[0].y();

    Eigen::Vector4f verts[3] = {
        Eigen::Vector4f(v[0].x(), v[0].y(), v[0].z(), v[0].w()),
        Eigen::Vector4f(v[1].x(), v[1].y(), v[1].z(), v[1].w()),
        Eigen::Vector4f(v[2].x(), v[2].y(), v[2].z(), v[2].w()),
    };
    ...
    for (int x = boxXmin; x < boxXmax; x++)
    {
        for (int y = boxYmin; y < boxYmax; y++)
        {
            ...
            alpha = (alpha / v[0].w()) * w_reciprocal;
            beta = (beta / v[1].w()) * w_reciprocal;
            gamma = (gamma / v[2].w()) * w_reciprocal;
            ...
            if (insideTriangle(x, y, verts) && z_interpolated < depth_buf[ind])
            {
